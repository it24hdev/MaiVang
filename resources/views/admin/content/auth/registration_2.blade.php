    ...
    <div class="row main-login-two">
        ...
        <div class="col-xl-4 col-lg-5 col-md-5 p-0">
            <div class="login-two-start">
                <h6 class="right-bar-heading px-3 mt-2 text-dark text-center font-30 text-uppercase">Đăng Ký</h6>
                <p class="text-center text-muted mt-1 mb-3 font-14">Điền thông tin và tạo tài khoản</p>
                <form method="post" action="{{route('admin.register_authentication')}}">
                    @csrf
                    ...
                    <div class="login-two-inputs  mt-4 check">
                        <div class="box">
                            ...
                            <label for="one">Tôi đồng ý với chính sách và điều khoản</label>
                        </div>
                    </div>
                    <div class="login-two-inputs mt-5 text-center d-flex">
                        ...
                        <a class="btn btn-sm btn-outline-primary btn-login w-100 ml-3 mr-3"
                           href="{{route('admin.login')}}" type="button">
                            Đăng Nhập
                        </a>
                    </div>
                </form>
