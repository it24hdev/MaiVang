    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Thêm mới phương thức thanh toán</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
                </button>
            </div>
            <div class="modal-body">
                <form id="form-create-payment-methods" class="general-info">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control m-0" name="type">
                                            ...
                                            <option value="member_point">Điểm thành viên (trừ điểu tích lũy của thành
                                                viên)
                                            </option>
