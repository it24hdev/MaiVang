                                ...
                                <div class="row general-info">
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <label for="image-edit">
                                                <img src="{{asset('media/common/'.\App\Admin\Http\Helpers\Common::noImage)}}"
                                                     width="150" height="150" id="view-image-edit" class="object-scale-down"
                                                     data-src="{{asset('media/common/'.\App\Admin\Http\Helpers\Common::noImage)}}">
                                            </label>
                                            <input type="file" accept="image/*" name="image" id="image-edit" class="d-none">
                                        </div>
                                    </div>
                                    <div class="d-flex flex-wrap w-100">
                                                ...
                                                <div class="d-flex justify-content-between form-group">
                                                    <div class="d-flex align-center">
                                                        <div class="d-flex align-center mr-4">
                                                            ...
                                                            <input type="radio" id="male-edit" name="gender" value="0">
                                                        </div>
                                                        <div class="d-flex align-center">
                                                            <label for="female-edit"
                                                                   class="mb-0 mr-2 text-black position-relative">Nữ</label>
                                                            <input type="radio" id="female-edit" name="gender" value="1">
                                                        </div>
                                                    </div>
                                                    <div class="d-flex align-center">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 info">
                                            <div class="form-group">
                                                <label>Tỉnh/TP</label>
                                                <select name="cities_id" class="form-control" id="cities-edit">
