@can('update', \App\Admin\Models\Page::class)
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title m-0" id="exampleModalScrollableTitle">Cập nhật trang</h5>
                    ...
                    <form id="update-page">
                        <div class="card-box add-product">
                            ...
                            <div class="form-group editor-box">
                                <label>Mô tả</label>
                                <textarea id="description-edit" class="form-control" name="description"></textarea>
                            </div>
                        </div>
                        <div class="card-box add-product">
                            <h6 class="m-0">Seo</h6>
