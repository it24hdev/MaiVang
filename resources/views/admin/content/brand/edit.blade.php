@can('update', \App\Admin\Models\Brand::class)
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-brand" enctype="multipart/form-data">
                        <div class="add-company-box">
                            <div class="add-company-content general-info">
                                <div class="row info">
                                    <div class="col-md-12">
                                        <div class="text-center">
                                            <input type="file" id="upload-image-edit" name="image" accept="image/*">
                                            <img id="view-image-edit" width="150" height="auto" class="background-white"
