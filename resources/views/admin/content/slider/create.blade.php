    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title m-0" id="exampleModalScrollableTitle">Thêm mới slider</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
                </button>
            </div>
            <div class="modal-body general-info">
                <form id="create-slider">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group text-center">
                                ...
                                <label for="image_web">
                                    <img src="{{asset('media/common/'.\App\Admin\Models\Slider::noImage)}}"
                                         width="150" height="150" id="view_image_web" class="object-scale-down"
                                         data-src="{{asset('media/common/'.\App\Admin\Models\Slider::noImage)}}">
                                </label>
                                <input type="file" accept="image/*" name="image_web" id="image_web"
                                       class="d-none">
                            </div>
                            ...
                            <div class="form-group text-center">
                                ...
                                <label for="image_mobile">
                                    <img src="{{asset('media/common/'.\App\Admin\Models\Slider::noImage)}}"
                                         width="150" height="150" id="view_image_mobile" class="object-scale-down"
                                         data-src="{{asset('media/common/'.\App\Admin\Models\Slider::noImage)}}">
                                </label>
                                <input type="file" accept="image/*" name="image_mobile" id="image_mobile"
                                       class="d-none">
                            </div>
                        </div>
                    </div>
